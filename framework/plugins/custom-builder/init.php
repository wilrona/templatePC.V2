...
class BuilderPlugin
{
    ...
    public $page_template = ['pageFestival.php'];
    ...
    function edit_form_after_title( $post )
    {
	        ...
	        if ( is_array( $this->post_types ) && in_array($post->post_type, $this->post_types) && in_array(get_page_template_slug($post->ID), $this->page_template)) :
